...
import com.nangseakheng.apigateway.constant.ApiGatewayConstant;
...
import com.nangseakheng.apigateway.exception.RouteCreateException;
import com.nangseakheng.apigateway.exception.RouteNotFoundException;
import com.nangseakheng.apigateway.repository.ApiRouteRepository;
import com.nangseakheng.apigateway.service.ApiRouteService;
...
import static com.nangseakheng.apigateway.constant.ApiGatewayErrorCodeConstant.INTERNAL_SERVER_ERROR;
import static com.nangseakheng.apigateway.constant.ApiGatewayErrorCodeConstant.NOT_FOUND;


// Slf4j is for logging
// RequiredArgsConstructor is for constructor injection
// Service is for marking this class as a service
@Slf4j
@Service
...
public class ApiRouteServiceImpl implements ApiRouteService {
    ...
    public Mono<RouteApiResponse> update(Long id, RouteApiRequest request) {
        return apiRouteRepository.update(id,
                ...
                // if id not found, throw RouteNotFoundException
    ...
    public Mono<Void> deleteById(Long id) {
        return apiRouteRepository.findFirstById(id)
                ...
                .onErrorResume(e -> {
                    log.info("Error deleting route by id: {}", e.getMessage());
