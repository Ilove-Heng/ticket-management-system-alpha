...
import com.nangseakheng.common.exception.GeneralErrorResponse;
...
public class RoleController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseErrorTemplate> update(@PathVariable Long id,@Validated @RequestBody RoleRequest roleRequest) {
